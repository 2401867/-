''' 27. В матрице B размером 5x7 4-й столбец матрицы заменить одномерным массивом, состоящим 
из максимальных  элементов строк, расположенных  в обратном порядке (т.е. 1-й элемент 4-го столбца 
- это максимальный элемент 5-й строки и т.д.).  '''

''' 6. В матрице размером nxn сформировать два одномерных массива: в один переслать по строкам 
верхний треугольник матрицы, включая элементы главной диагонали, в другой - нижний треугольник. 
Вывести верхний и нижний треугольники по строкам.
Программу составить в 2-х вариантах, представляя матрицу: 
   а) в виде двухмерного  массива; 

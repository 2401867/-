...
площадь кольца, заключенного между двумя окружностями с радиусами A и B; площадь равнобедреннего 
треугольника со сторонами A, B, C. Использовать множественный выбор'''
